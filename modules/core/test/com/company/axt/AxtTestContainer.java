...
public class AxtTestContainer extends TestContainer {

    public AxtTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/axt/app.properties",
    ...
    public static class Common extends AxtTestContainer {

        public static final AxtTestContainer.Common INSTANCE = new AxtTestContainer.Common();
